##
## Exploratory Data Analysis: Week01: Project: Plot 4
##
...
plot(ghData$Time, 
     ghData$Global_reactive_power, 
     type="l",
     xlab="datetime",
     ylab="Global_reactive_power"
     )

par(mfrow = c(1,1)) # back to 1 up
